...
-------
    git clone https://github.com/rameshpasupulety/spring-cloud-kubernetes
...
--------------
    docker build -t rameshpasupulety/kubernetes-configmap-reload .
...
-----------
    docker push rameshpasupulety/kubernetes-configmap-reload
